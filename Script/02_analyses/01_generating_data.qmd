...
# Generate continuous variables for:
# - z1, z2, z3 (first three continuous variables)
# - z7, z8, z9, z10, z11 (next five continuous variables)
# Total continuous variables = 3 + 5 = 8.
mean_vec <- rep(0, 8)
cov_matrix <- diag(8)  # identity covariance matrix (adjust if needed)
mv_data <- mvrnorm(n = n, mu = mean_vec, Sigma = cov_matrix)

# Assign column names: first 3 as z1,z2,z3, and next 5 as z7,...,z11.
...
# Combine everything into a final data frame in the order:
# name, time, z1, z2, z3, (binary z4, z5, z6), z7, z8, z9, z10, z11, (binary z12 to z16)
covar <- data.frame(
  name = 1:n,
  time = 0,
  mv_data[, c("z1", "z2", "z3")],
...
for (i in 1:100) {
  ...
  edgelist <- remulateTie(effects,
                          ...
                          time = 10000)
  save(edgelist,
       file = paste0("../GeneratedData/edgelists/edgelist_", i, ".RData"))
}
```
...
for (i in seq_along(sample_sizes)) {
  ...
  generate_edgelists_independent_parallel(
    effects = effects,
