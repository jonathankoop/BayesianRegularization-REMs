...
ggsave("../Plots/01_coefficient_plots/plots_mle.png", plots_mle_combined,
       width = 10, height = 15)
```
...
ggsave("../Plots/01_coefficient_plots/plots_abr_hs.png", plots_abr_hs_combined,
       width = 10, height = 15)
```
...
ggsave("../Plots/01_coefficient_plots/plots_abr_ridge.png", plots_abr_ridge_combined,
       width = 10, height = 15)
