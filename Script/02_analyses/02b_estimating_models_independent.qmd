...
```{r}
bias_all <- bind_rows(
  bias_mle        %>% rename(mean = bias_mle_mean,   var = bias_mle_var)   %>% mutate(method = "mle"),
  bias_abr_hs     %>% rename(mean = bias_abr_hs_mean, var = bias_abr_hs_var) %>% mutate(method = "abr_hs"),
  bias_abr_ridge  %>% rename(mean = bias_abr_ridge_mean, var = bias_abr_ridge_var) %>% mutate(method = "abr_ridge")
) %>% 
...
ggsave("../Plots/01_coefficient_plots/plots_mle_independent.png", plots_mle_combined,
       width = 10, height = 15)
```
...
ggsave("../Plots/01_coefficient_plots/plots_abr_hs_independent.png", plots_abr_hs_combined,
       width = 10, height = 15)
```
...
ggsave("../Plots/01_coefficient_plots/plots_abr_ridge_independent.png", plots_abr_ridge_combined,
       width = 10, height = 15)
