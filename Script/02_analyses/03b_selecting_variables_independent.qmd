...
```{r}
tdr_endo <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
...
save(tdr_endo, file = "../Results/04b_discovery_rates_independent/true_discovery_rate_endogenous.RData")
```

### Exogenous Predictors

```{r}
tdr_exo_weak <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = FALSE,
...
save(tdr_exo_weak, file = "../Results/04b_discovery_rates_independent/true_discovery_rate_exogenous_weak.RData")

tdr_exo_medium <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = FALSE,
...
save(tdr_exo_medium, file = "../Results/04b_discovery_rates_independent/true_discovery_rate_exogenous_medium.RData")

tdr_exo_strong <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = FALSE,
...
save(tdr_exo_strong, file = "../Results/04b_discovery_rates_independent/true_discovery_rate_exogenous_strong.RData")

tdr_exo <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = FALSE,
...
save(tdr_exo, file = "../Results/04b_discovery_rates_independent/true_discovery_rate_exogenous.RData")
```
...
```{r}
fdr_endo <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = TRUE,
...
save(fdr_endo, file = "../Results/04b_discovery_rates_independent/false_discovery_rate_endogenous.RData")
```

### Exogenous Predictors

```{r}
fdr_exo <- discovery_rate(folder = "../Results/03b_selected_variables_independent/",
                           parameters = parameters,
                           m = c(100, 200, 400, 800, 1600, 3200, 6400),
                           num_edgelists = 100,
                           endo = FALSE,
...
save(fdr_exo, file = "../Results/04b_discovery_rates_independent/false_discovery_rate_exogenous.RData")
```
...
ggsave("../Plots/02_variable_selection/true_discovery_rates_independent.png", combined_plot_true, width = 12, height = 8)
```
...
ggsave("../Plots/02_variable_selection/false_discovery_rates_independent.png", combined_plot_false, width = 12, height = 5)
```
...
ggsave("../Plots/02_variable_selection/distance_plots_independent.png", combined_plot_dist, width = 12, height = 5)
```
...
ggsave("../Plots/02_variable_selection/mcc_plots_independent.png", combined_plot_mcc, width = 12, height = 5)
```
